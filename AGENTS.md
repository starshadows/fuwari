...
- Focused tests: `pnpm vitest run src/worker/__tests__/utils.test.ts` or another `src/**/*.test.ts` path. Current tests are Worker-focused and mock D1/R2/ASSETS bindings.
