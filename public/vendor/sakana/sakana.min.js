!((t, e) => {
	...
	var t,
		e = [],
		i = () => e.some((t) => t.activeTargets.length > 0),
	...
	var r,
		n = (t) => Object.freeze(t),
		o = function (t, e) {
			(this.inlineSize = t), (this.blockSize = e), n(this);
		},
		a = (() => {
			function t(t, e, i, s) {
				return (
		...
		h = (t) => t instanceof SVGElement && "getBBox" in t,
		c = (t) => {
			if (h(t)) {
				var e = t.getBBox(),
					i = e.width,
		...
		m = (t) => Number.parseFloat(t || "0"),
		C = (t, e, i) => (
			void 0 === t && (t = 0),
			void 0 === e && (e = 0),
			void 0 === i && (i = !1),
			new o((i ? e : t) || 0, (i ? t : e) || 0)
		),
		v = n({
		...
		F = (t, e) => {
			...
			if (c(t)) return d.set(t, v), v;
			var i = getComputedStyle(t),
				s = h(t) && t.ownerSVGElement && t.getBBox(),
				r = !p && "border-box" === i.boxSizing,
				o = W.test(i.writingMode || ""),
				l = !s && g.test(i.overflowY || ""),
				u = !s && g.test(i.overflowX || ""),
				F = s ? 0 : m(i.paddingTop),
				V = s ? 0 : m(i.paddingRight),
				w = s ? 0 : m(i.paddingBottom),
				Y = s ? 0 : m(i.paddingLeft),
				y = s ? 0 : m(i.borderTopWidth),
				L = s ? 0 : m(i.borderRightWidth),
				A = s ? 0 : m(i.borderBottomWidth),
				b = Y + V,
				S = F + w,
				E = (s ? 0 : m(i.borderLeftWidth)) + L,
				K = y + A,
				x = u ? t.offsetHeight - K - t.clientHeight : 0,
				I = l ? t.offsetWidth - E - t.clientWidth : 0,
				B = r ? b + E : 0,
				f = r ? S + K : 0,
				J = s ? s.width : m(i.width) - B - I,
				k = s ? s.height : m(i.height) - f - x,
				D = J + b + I + E,
				q = k + S + x + K,
				Z = n({
					devicePixelContentBoxSize: C(
					...
					borderBoxSize: C(D, q, o),
					contentBoxSize: C(J, k, o),
					contentRect: new a(Y, F, J, k),
				});
			return d.set(t, Z), Z;
		},
		V = (e, i, s) => {
		...
		w = function (t) {
			...
			(this.target = t),
				...
				(this.borderBoxSize = n([e.borderBoxSize])),
				(this.contentBoxSize = n([e.contentBoxSize])),
				(this.devicePixelContentBoxSize = n([e.devicePixelContentBoxSize]));
		},
		Y = (t) => {
			if (c(t)) return 1 / 0;
		...
		y = () => {
			...
			e.forEach((e) => {
				if (0 !== e.activeTargets.length) {
					var s = [];
					e.activeTargets.forEach((e) => {
						var i = new w(e.target),
							r = Y(e.target);
						s.push(i),
							(e.lastReportedSize = V(e.target, e.observedBox)),
							r < t && (t = r);
					}),
						i.push(() => {
		...
		L = (t) => {
			e.forEach((e) => {
				e.activeTargets.splice(0, e.activeTargets.length),
					...
					e.observationTargets.forEach((i) => {
						i.isActive() &&
							(Y(i.target) > t
		...
		A = () => {
			...
			for (L(r); i(); ) (r = y()), L(r);
			return (
				e.some((t) => t.skippedTargets.length > 0) &&
					("function" == typeof ErrorEvent
						? (t = new ErrorEvent("error", { message: s }))
		...
		S = (t) => {
			if (!r) {
				...
				new MutationObserver(() => b.splice(0).forEach((t) => t())).observe(i, {
					characterData: !0,
				}),
					(r = () => {
		...
		f = new ((() => {
			...
			return (
					...
					if ((void 0 === t && (t = 250), !B)) {
						...
						(i = () => {
							...
							try {
								...
								if (((B = !1), (t = s - I()), !E)) return;
								i ? this.run(1e3) : t > 0 ? this.run(t) : this.start();
							}
						}),
							S(() => {
				...
				(t.prototype.observe = function () {
					var e = () =>
						this.observer && this.observer.observe(document.body, K);
				...
				(t.prototype.start = function () {
					this.stopped &&
						...
						this.observe(),
						x.forEach((e) => u.addEventListener(e, this.listener, !0)));
				}),
				(t.prototype.stop = function () {
					this.stopped ||
						(this.observer && this.observer.disconnect(),
						x.forEach((e) => u.removeEventListener(e, this.listener, !0)),
						(this.stopped = !0));
				}),
				t
			);
		...
		k = (() => {
			...
			return (
				(e.prototype.isActive = function () {
					var t,
						e = V(this.target, this.observedBox, !0);
					return (
						(t = this.target),
						h(t) ||
							((t) => {
		...
		O = (() => {
			...
			return (
				...
				(t.observe = (t, i, s) => {
					...
					Z(r.observationTargets, i) < 0 &&
						(n && e.push(r),
						r.observationTargets.push(new k(i, s && s.box)),
						J(1),
						f.schedule());
				}),
				(t.unobserve = (t, i) => {
					var s = q.get(t),
						r = Z(s.observationTargets, i),
				...
				(t.disconnect = function (t) {
					var i = q.get(t);
					i.observationTargets
						.slice()
						.forEach((i) => this.unobserve(t, i.target)),
	...
	class P {
		...
		static getCharacters = () => (null == Q && X(), M(Q));
		static registerCharacter = (t, e) => {
			const i = M(e);
			let s = i.initialState.i;
			(s = Math.min(0.5, Math.max(0, s))), (i.initialState.i = s), (Q[t] = i);
		};
		constructor(t = {}) {
			null == Q && X(),
				(this._options = M(T)),
				(this._options = z(this._options, t)),
		...
		_updateSize = (t) => {
			...
			const e = ((t, e, i = 2 * (window.devicePixelRatio || 1)) => {
				const s = e * i;
		...
		_updateDom = () => {
			...
			(c.className = o),
				(c.href = "//github.com/Lentinel/plugin-Sakana-widget-Halo"),
				(c.target = "_blank"),
				(c.innerHTML =
		...
		nextCharacter = () => {
			const t = Object.keys(P.getCharacters()).sort(),
